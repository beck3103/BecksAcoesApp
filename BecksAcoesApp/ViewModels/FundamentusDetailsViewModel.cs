...
internal sealed class FundamentusDetailsViewModel
{
    ...
    /// </summary>
    public string DataUltimaAtualizacao { get; set; } = string.Empty;

    /// <summary>
    /// Lucro Líquido: o lucro líquido da empresa após deduzir todas as despesas, impostos e custos.
    /// </summary>
    public string LucroLiquido { get; set; } = string.Empty;

    /// <summary>
    /// Quantidade de Ações: o número total de ações emitidas pela empresa.
    /// </summary>
    public string QuantidadeDeAcoes { get; set; } = string.Empty;
    ...
    /// <summary>
    /// Nome da empresa associada ao ativo.
    /// </summary>
    ...
    /// <summary>
    /// Subsetor ao qual a empresa pertence.
    /// </summary>
